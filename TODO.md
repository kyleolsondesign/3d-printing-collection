...
- [ ] Search on the import page should filter the importable models
- [ ] Add a "Show in Finder" button to the ingestion rows so I can manually review the model files
- [ ] After manually selecting a category in the ingestion view, select the row for that model
- [ ] Allow batch assigning of categories in the ingestion view by setting all the selected items to the same category
- [ ] Make the "select all" and "import" box sticky at the top of the screen when you scroll past it on the ingestion view
