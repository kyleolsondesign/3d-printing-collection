...
- [x] Add a "Show in Finder" button to the ingestion rows so I can manually review the model files
...
- [ ] Ignore all states for "Prints Over Time" before March 2026
- [ ] Add desginer statistics to the stats page
